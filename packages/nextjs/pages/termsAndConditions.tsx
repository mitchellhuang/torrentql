...
<>
  ...
  <Markdown>
    By the Account Activation Date of each month, torrentql shall either:
  </Markdown>
  <br/>
  <br/>
  <Markdown>
    (1) debit the client’s credit card (when such information has
    been provided by the client); or
  </Markdown>
  <br/>
  <br/>
  <Markdown>
    (2) deliver, by e-mail or regular mail, an invoice in accordance
    with the applicable Service Fees for services rendered for the
    current month. When an invoice is delivered to the client, 
    payment shall be remitted to torrentql by no later than the 
    specified payment due date. torrentql shall be entitled to 
    immediately terminate this agreement for clients failure to 
    make timely payments. You will be provided with an invoice on
    a monthly basis. All credit cards are billed automatically on
    a monthly basis. It is the client’s responsibility to ensure 
  ...
  <br/>
  <Markdown>
   (3) Filing a dispute/chargeback for any paid sum will void 
...
Any account deactivated due to non-payment will require a reactivation fee of €10.00 prior to reactivation. Excepted from this is ‘Premium Seedboxes’ , ‘Mini seedboxes’ and ’Storage slots’.
   </Markdown>
  <Markdown>
...
We do not refund partial monthly fees to accounts. We require 3 days notice for a cancellation for ‘Dedicated Seedboxes’ and ‘Dedicated Servers’.
   </Markdown>
  <Markdown>
...
torrentql shall not be responsible for any claimed damages, including incidental and consequential damages, which may arise from seedbox.ios servers going off-line or being unavailable for any reason whatsoever. Furthermore, torrentql shall not be responsible for any claimed damages, including incidental or consequential damages, resulting from the corruption or deletion of any web site from one of torrentql ‘ servers. All damages shall be limited to the immediate termination of service.
 
Violations
Violations of these Acceptable Use Policies should be referred to abuse [at] torrentql. All complaints will be investigated promptly. Failure to follow any term or condition will be grounds for immediate account deactivation.
 
Disclaimer
torrentql cannot be held liable for system down time, crashes or data loss. We cannot be held liable for any predicated estimate of profits which a client would have gained if their site was functioning. Certain services provided by torrentql are resold. Thus, certain equipment, routing, software and programming used by torrentql are not directly owned or written by torrentql. Moreover, torrentql holds no responsibility for the use of our clients’ accounts. Failure to comply with any terms or conditions will result in the automatic deactivation of the account in question. We reserve the right to remove any account, without advance notice for any reason without restitution, as torrentql sees fit.

Account Activation
By activating your account with torrentql, you agree to the above policies and disclaimer. Upon requesting activation of an account, you are required to accept these policies, guidelines and disclaimer, and a copy of your acceptance is forwarded along with your activation request to be maintained with your account information.
...
Although torrentql has an excellent record for reliability, we do not offer an uptime guarantee. However, our network and servers are monitored continuously, and are rarely down except for scheduled maintenance and hardware and software upgrades.
 
torrentql reserves the right to amend any or all of the above policies, guidelines and disclaimer without notification. We also retain the right to increase any pricing and make changes to our account plans without notification.

Acceptable Use Policy
 
As a provider of web site hosting and other Internet-related services, torrentql offers its customer (also known as “Subscribers”) and their customers and users the means to acquire and disseminate a wealth of public, private, commercial and non-commercial information. torrentql respects that the Internet provides a forum for free and open discussion and dissemination of information. However, when there are competing interests at issue, torrentql reserves the right to take certain preventive or corrective actions. In order to protect these competing interests, torrentql has developed an Acceptable Use Policy (“AUP”), which supplements and explains certain terms of each customer’s respective service agreement, and is intended as a guide to the customer’s rights and obligations when using torrentql’ services. This AUP will be revised from time to time.
...
Spamming: 
torrentql has a zero tolerancy policy against spamming, in case of torrentql's service being used for sending out spam, will result in termination of the service. Sending unsolicited bulk and/or commercial information over the Internet. It is not only harmful because of its negative impact on consumer attitudes toward torrentql, but also because it can overload torrentql’ network and disrupt service to torrentql’ subscribers. Also, maintaining an open SMTP relay is prohibited. When a complaint is received, torrentql will investigate and shutdown the account that is SPAMing. A $250 charge for violating this policy will be charged to the person initiating the SPAM. Furthermore torrentql reserves the right to prosecute for this violation. A $1.00 charge will be assessed PER EMAIL sent should torrentql choose to pursue and prosecute.
...
Using torrentql’ network as a means to transmit or post negative, defamatory, harassing, abusive or threatening language.
...
Hosting a public filesharing site or streaming site which negatively hurt the reputation of torrentql
...
Other Activities: 
Engaging in activities, whether lawful or unlawful, that torrentql determines to be harmful to its subscribers, operations, reputation, goodwill or customer relations.
